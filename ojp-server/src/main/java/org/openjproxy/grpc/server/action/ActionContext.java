...
/**
 * ActionContext holds all shared state and dependencies needed by Action
 * classes.
 * This context is created once in StatementServiceImpl and passed to all
 * actions.
 * 
...
public class ActionContext {
    ...
    /**
     * Cluster health tracker for monitoring health changes and triggering
     * rebalancing.
     */
    ...
    public ActionContext(
            ...
            SqlEnhancerEngine sqlEnhancerEngine) {
